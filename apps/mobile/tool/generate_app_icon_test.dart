...
void main() {
  ...
  test('generate app icon png', () async {
    ...
    tp1.paint(canvas, Offset(size * 0.3, size * 0.28));
    ...
    tp2.paint(canvas, Offset(size * 0.56, size * 0.54));

    final glow = Paint()
      ..color = const Color(0x66FFFFFF)
      ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 24);
    canvas.drawCircle(Offset(size * 0.22, size * 0.18), size * 0.08, glow);
    ...
    canvas.drawArc(
      Rect.fromCircle(center: Offset(size / 2, size / 2), radius: size * 0.43),
      -math.pi * 0.35,
      math.pi * 0.7,
      false,
      ring,
